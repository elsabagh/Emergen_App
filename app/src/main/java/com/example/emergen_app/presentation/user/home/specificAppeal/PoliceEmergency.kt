...
fun PoliceEmergency(navController: NavController) {
    ...
    val typeOfRequest = "Police Emergency"
    ...
    Scaffold(
        ...
        content = { paddingValues ->
            Column(
                ...
                EmergencyOption("Armed Robbery", selectedOption) { selectedOption = it }
                EmergencyOption("Violent Assault", selectedOption) { selectedOption = it }
                EmergencyOption("Kidnapping", selectedOption) { selectedOption = it }
